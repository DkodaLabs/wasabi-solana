...
export const ownerTokenA = getAssociatedTokenAddressSync(
    tokenMintA,
...
export const ownerTokenB = getAssociatedTokenAddressSync(
    tokenMintA,
    program.provider.publicKey,
    false,
    TOKEN_PROGRAM_ID
...
const [coSignerPermission] = web3.PublicKey.findProgramAddressSync(
    [
...
export const [invalidPermission] = web3.PublicKey.findProgramAddressSync(
    [
        utils.bytes.utf8.encode("admin"),
